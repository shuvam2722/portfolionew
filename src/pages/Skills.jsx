...
function Skills() {
  const my_skill_description = [
    ...
    {
      index: 2,
      info: "⚡Developing mobile applications using React JS , Node JS and Material UI, Firebase ",
    },
    {
      index: 3,
      info: "⚡ Creating user friendly UI/UX and turning those designs into codes",
    },
  ];
  return (
    <>
      <section id="my_skill">
        <div className="my_skills">
          <h2>
            My Skills & <span>Tech</span> Stacks
          </h2>
        </div>
